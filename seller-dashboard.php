...
if (!empty($_GET["action"])) {
    switch ($_GET["action"]) {
        case "update_order_status":
            ...
            break;
        case "create_coupon":
            $sql = "INSERT INTO `coupons` (`amount`, `min_spend`, `coupon_id`, `customer_id`, `seller_id`) VALUES ('" . $_POST['amount'] . "','" . $_POST['min_spend'] . "','" . $_POST['coupon_id'] . "','" . $_POST['customer_id'] . "','1')";
...
<body>
    ...
    <div class="txt-heading">Create Coupon</div>
    <div class="section">
        <div class="section-border">
            <form method="post" action="?action=create_coupon">
                <label for="amount">Amount:</label>
                <input type="text" name="amount"><br><br>
                <label for="min_spend">Minimum Spend:</label>
                <input type="text" name="min_spend"><br><br>
                <label for="coupon_id">Coupon No:</label>
                <input type="text" name="coupon_id"><br><br>
                <label for="customer_id">Customer ID:</label>
                <input type="text" name="customer_id"><br><br>
                <input class="btnUpdate" type="submit" value="Create Coupon">
            </form>
        </div>
    </div>
    <br>
